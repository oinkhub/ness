...
final class Tab: UIView {
    ...
    init() {
        ...
        let settings = Button("settings", target: app.browse)
        self.settings = settings
        
        let market = Button("market", target: app.browse)
        self.market = market
        
        let home = Button("home", target: app.browse)
        self.home = home
        
        let add = Button("add", target: app.browse)
        self.add = add
        
        let history = Button("history", target: app.browse)
